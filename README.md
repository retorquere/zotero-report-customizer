...
version](https://raw.github.com/friflaj/zotero-report-customizer/master/zotero-report-customizer-0.0.14.xpi) (**0.0.14**, released
on 2014-01-28 12:31). If you are not prompted with a Firefox installation dialog then double-click the downloaded xpi;
