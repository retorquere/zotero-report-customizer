...
version](https://raw.github.com/friflaj/zotero-report-customizer/master/zotero-report-customizer-0.0.13.xpi) (**0.0.13**, released
on 2014-01-25 00:17). If you are not prompted with a Firefox installation dialog then double-click the downloaded xpi;
...
or support requests on anything but the latest version, currently at **0.0.13**. If you submit an issue report,
